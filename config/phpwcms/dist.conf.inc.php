...
$phpwcms['content_width']     = 800; // max width of the article content column - important for rendering multi column images
...
$phpwcms['max_time']          = 18000; // logout after max_time/60 seconds
...
$phpwcms['viewport']		  = ''; // set viewport like "width=device-width, initial-scale=1.0"
