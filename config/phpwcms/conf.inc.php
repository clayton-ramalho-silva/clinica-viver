...
$phpwcms['db_user']           = 'u186798781_viver';
$phpwcms['db_pass']           = 'AgMore1996';
$phpwcms['db_table']          = 'u186798781_viver';
$phpwcms['db_prepend']        = '';
$phpwcms['db_pers']           = 0;
$phpwcms['db_charset']        = 'latin1';
$phpwcms['db_collation']      = 'latin1_general_ci';
$phpwcms['db_version']        = 100515;
...
$phpwcms['admin_name']        = 'Clinica Viver'; //default: Webmaster
$phpwcms['admin_user']        = 'admin'; //default: admin
$phpwcms['admin_pass']        = '5f2056809c95b8fa8ba74e3c57fd19b6'; //MD5(phpwcms)
$phpwcms['admin_email']       = 'lucas@ldweb.com.br'; //default: noreplay@host

// paths
$phpwcms['DOC_ROOT']          = $_SERVER['DOCUMENT_ROOT'];// current DOC_ROOT seems to be: '/home/u186798781/domains/criacaodesites.online/public_html' 
$phpwcms['root']         		= 'viver';         //default: ''
...
$phpwcms['content_width']     = 1920; //max width of the article content column - important for rendering multi column images
$phpwcms['img_list_width']    = 300; //max with of the list thumbnail image
$phpwcms['img_list_height']   = 300; //max height of the list thumbnail image
...
$phpwcms['max_time']          = 18000000; //logout after max_time/60 seconds
...
$phpwcms['default_lang']      = 'pt';  //default language
$phpwcms['charset']           = 'iso-8859-1';  //default charset 'utf-8'
$phpwcms['php_charset']       = false; // set PHP default charset to 
...
$phpwcms['video-js']          = ''; // can be stored locally too 'template/lib/video-js/ (//vjs.zencdn.net/4.8/)
...
$phpwcms['browser_check']     = array('fe'=>false, 'be'=>false, 'vs' => ''); // enable Browser Update check in frontend and/or backend, use 'vs' to which browser version, see http://www.browser-update.org/index.html#install
...
$phpwcms['viewport']		  = 'width=device-width, initial-scale=1.0'; // set viewport like "width=device-width, initial-scale=1.0"
...
$phpwcms['SMTP_PORT']         = 587; // SMTP server port (default 25)
...
$phpwcms['palavras'] = 17; // Valor de limite de palavras de RSS Feeds
$phpwcms['LarguraGeral'] = '100%';
$phpwcms['LarguraInterna'] = '100%';
$phpwcms['LarguraInterna2'] = '100%';
$phpwcms['Modo'] = '1'; // Gerenciamento de Opções da ferramenta: 1 = Administrador, 0 = Usuário
$phpwcms['Modulos'] = '0'; // Habilita ou Desabilita a opção Módulos
$phpwcms['ListaEmails'] = '0'; // Habilita ou Desabilita a opção Lista de E-mails
$phpwcms['Admin'] = '0'; // Habilita ou Desabilita a opção Administrador
$phpwcms['divFone'] = '0'; // Habilita ou Desabilita a div em volta dos telefones
$phpwcms['btDados'] = '1'; // Habilita ou desabilita o botão de Dados da Empresa
$phpwcms['btPedido'] = '0'; // Habilita ou desabilita o botão de Pedido e Produtos
$phpwcms['btBanners'] = '0'; // Habilita ou desabilita o botão de Banners ADS
$phpwcms['btSistema'] = '0'; // Habilita ou desabilita o botão de Sistema Personalizado
