...
CREATE TABLE `phpwcms_dados` (
  `dados_empresa` varchar(255) NOT NULL DEFAULT '',
  `dados_fone` text NOT NULL,
  `dados_fone_checkbox` text NOT NULL,
  `dados_whatsapp` text NOT NULL,
  `dados_redes` text NOT NULL,
  `dados_emails` text NOT NULL,
  `dados_endereco` text NOT NULL,
  `dados_rodape` text NOT NULL,
  `dados_meta` text NOT NULL,
  `dados_analytics` text NOT NULL,
  `dados_webmaster` text NOT NULL,
  `dados_classe_fone` int(1) NOT NULL,
  `dados_campo_adicional1` text NOT NULL,
  `dados_campo_adicional2` text NOT NULL,
  PRIMARY KEY (`dados_empresa`)
);
...
CREATE TABLE `phpwcms_shop_boleto` (
  `boleto_id` int(1) NOT NULL AUTO_INCREMENT,
  `boleto_codigo` varchar(255) NOT NULL,
  `boleto_pedido` varchar(20) NOT NULL,
  `boleto_nome` text NOT NULL,
  `boleto_cidade` text NOT NULL,
  `boleto_estado` varchar(2) NOT NULL,
  `boleto_cep` varchar(255) NOT NULL,
  `boleto_info` text NOT NULL,
  `boleto_valor` varchar(255) NOT NULL,
  `boleto_criacao` date NOT NULL,
  `boleto_processamento` date NOT NULL,
  `boleto_vencimento` date NOT NULL,
  `boleto_email` varchar(255) NOT NULL,
  `boleto_status` int(1) NOT NULL,
