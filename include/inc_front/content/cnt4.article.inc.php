...
// read template
if(empty($crow["acontent_template"]) && is_file(PHPWCMS_TEMPLATE.'inc_default/blocotexto.tmpl')) {

	$tabs['template']	= render_device( @file_get_contents(PHPWCMS_TEMPLATE.'inc_default/blocotexto.tmpl') );
	
} elseif(is_file(PHPWCMS_TEMPLATE.'inc_cntpart/blocotexto/'.$crow["acontent_template"])) {

	$tabs['template']	= render_device( @file_get_contents(PHPWCMS_TEMPLATE.'inc_cntpart/blocotexto/'.$crow["acontent_template"]) );
