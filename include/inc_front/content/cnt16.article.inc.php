...
} elseif(is_file(PHPWCMS_TEMPLATE.'inc_cntpart/imagespecial/banner.html')) {

	$image['template'] = render_device( @file_get_contents(PHPWCMS_TEMPLATE.'inc_cntpart/imagespecial/banner.html') );
...
if($image['template']) {
    ...
    $image['template']  = render_cnt_template($image['template'], 'TEMPO', $image['tempo']);
