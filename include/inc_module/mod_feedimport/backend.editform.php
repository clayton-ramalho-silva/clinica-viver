...
<?php
	...
	foreach($plugin['fields'] as $key => $value) {
		...
		echo '<td>&nbsp;<a href="#" title="'.$BL['be_cnt_openfilebrowser'].'" onclick="return openFileBrowser(\''.$key.'\');"><img src="img/button/open_image_button.gif" alt="" width="71" height="15" border="0" /></a></td>';
