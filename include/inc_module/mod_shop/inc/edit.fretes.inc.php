...
<form action="<?php echo shop_url( array('controller=prod', 'edit='.$plugin['data']['shopprod_id']) ) ?>" method="post" class="editform" onsubmit="selectAllOptions(this.shopprod_images);selectAllOptions(this.shopprod_files);">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" summary="">
	...
	<tr>
		<td align="right" class="chatlist" width="30%">
			<?php echo $BL['be_cnt_last_edited'] ?>:&nbsp;
        </td>
        
		<td class="v10" width="410" width="70%">
		<?php
	...
	<tr>
		<td align="right" class="chatlist">
			<?php echo $BLM['shopprod_ordernumber'] ?>:&nbsp;
        </td>
		<td>
        	<table cellpadding="0" cellspacing="0" border="0" summary="">
				<tr>
					<td>
                    	<input name="shopprod_ordernumber" type="text" id="shopprod_ordernumber" class="v12 width125 bold<?php
						//error class
						if(!empty($plugin['error']['shopprod_ordernumber'])) echo ' errorInputText';
						?>" value="<?php echo html($plugin['data']['shopprod_ordernumber']) ?>" size="30" maxlength="20" />
        			</td>
					<td align="right" class="chatlist width100">
						<?php echo $BLM['shopprod_model'] ?>:&nbsp;
                    </td>
					<td>
                    	<input name="shopprod_model" type="text" id="shopprod_model" class="v12" value="<?php echo html($plugin['data']['shopprod_model']) ?>" size="30" maxlength="200" style="width:162px" />
                    </td>
				</tr>
			</table>
        </td>
	...
	<tr><td colspan="2"><img src="img/leer.gif" alt="" width="1" height="9" /></td></tr>
	...
	<tr>
		...
		<td class="v10" width="410">
        	<table cellpadding="0" cellspacing="0" border="0" summary="">
				<tr>
					<td>
                    	<input type="radio" name="shopprod_lang" id="shopprod_lang_0" value=""<?php is_checked($plugin['data']['shopprod_lang'], '') ?> />
                    </td>
					<td>
                    	<label for="shopprod_lang_0"><?php echo $BL['be_ftptakeover_all'] ?></label>&nbsp;&nbsp;
                    </td>
					<?php 
                    ...
                    ?>
                    	<td>
                            <input type="radio" name="shopprod_lang" id="shopprod_lang_<?php echo $lang ?>" value="<?php echo $lang ?>"<?php is_checked(strtolower($plugin['data']['shopprod_lang']), $lang) ?> />
                        </td>
                        <td>
                           <label for="shopprod_lang_<?php echo $lang ?>">
                                <img src="img/famfamfam/lang/<?php echo $lang; $lang = strtoupper($lang); ?>.png" alt="<?php echo $lang ?>" title="<?php echo $lang ?>" />
                            </label>&nbsp;&nbsp;
                        </td>
	...
	<tr>
		<td align="right" class="chatlist">
			<?php echo $BLM['shopprod_name1'] ?>:&nbsp;
        </td>
		<td>
        	<input name="shopprod_name1" type="text" id="shopprod_name1" class="v12 width400 bold<?php
			//error class
			if(!empty($plugin['error']['shopprod_name1'])) echo ' errorInputText';
			?>" value="<?php echo html($plugin['data']['shopprod_name1']) ?>" size="30" maxlength="200" />
        </td>
	</tr>
    ...
    <tr>
		<td align="right" class="chatlist"><?php echo $BLM['prod_cat'] ?>:&nbsp;</td>
		<td>
        	<table cellpadding="0" cellspacing="0" border="0" summary="">
                <tr>
                    <td>
                        <select name="shopprod_category[]" size="1" class="v12" id="shopprod_category" style="width:412px">
                        <?php
                        $t = array();
	...
	<tr>
    	<td colspan="2">
        	<img src="img/leer.gif" alt="" width="1" height="6" />
        </td>
    </tr>

	<tr>
		<td align="right" class="chatlist">
			<?php echo $BLM['shopprod_name2'] ?>:&nbsp;
        </td>
		<td>
        	<input name="shopprod_name2" type="text" id="shopprod_name2" class="v12 width400" value="<?php echo html($plugin['data']['shopprod_name2']) ?>" size="30" maxlength="200" />
        </td>
	</tr>

	<tr>
    	<td colspan="2">
        	<img src="img/leer.gif" alt="" width="1" height="3" />
        </td>
    </tr>
	*/ ?>
	...
	<tr>
		<td align="right" class="chatlist">
			<?php echo $BLM['shopprod_weight'] ?>:&nbsp;
        </td>
		<td>
        	<table cellpadding="0" cellspacing="0" border="0" summary="">
				<tr>
					<td>
                    	<input name="shopprod_weight" type="text" id="shopprod_weight" class="v12 width125 right" value="<?php echo number_format($plugin['data']['shopprod_weight'], 3, $BLM['dec_point'], $BLM['thousands_sep']); ?>" size="30" maxlength="200" />
                    </td>
					<td class="chatlist">&nbsp;
					<?php
    ...
    <tr>
		<td align="right" class="chatlist">
			<?php echo $BLM['shopprod_price'] ?>:&nbsp;
        </td>
		<td>
        	<table cellpadding="0" cellspacing="0">
            	<tr>
                	<td>
                        <input name="shopprod_price" type="text" id="shopprod_price" class="v12 width125 bold right<?php if(!empty($plugin['error']['shopprod_price'])) echo ' errorInputText'; ?>" value="<?php
                         	$dec_lenght = strlen(strrchr($plugin['data']['shopprod_price'],'.')) - 1;
                            if($dec_lenght < 2) $dec_lenght = 2;
                            echo number_format($plugin['data']['shopprod_price'], $dec_lenght, $BLM['dec_point'], $BLM['thousands_sep']); ?>" size="30" />
                	</td>
                    <td align="right" class="chatlist width100">
						<?php echo $BLM['shopprod_ordem'] ?>:&nbsp;
                    </td>
					<td>
                    	<input name="shopprod_ordenacao" type="text" id="shopprod_ordenacao" class="v12" value="<?php echo html($plugin['data']['shopprod_ordenacao']) ?>" size="30" style="width:162px" />
                    </td>
                </tr>
        	</table>
        </td>
	...
	<tr>
		<td align="right" class="chatlist tdtop4">
			<?php echo $BLM['shopprod_size'] ?>:&nbsp;
        </td>
		<td>
        	<table cellpadding="0" cellspacing="0" border="0" summary="">
				<tr>
					<td>
                    	<textarea name="shopprod_size" id="shopprod_size" class="v12 width125" rows="5" cols="15"><?php echo html($plugin['data']['shopprod_size']) ?></textarea>
                    </td>
					<td align="right" class="chatlist width100 tdtop4"><?php echo $BLM['shopprod_color'] ?>:&nbsp;</td>
					<td>
                    	<textarea name="shopprod_color" id="shopprod_color" class="v12 width170" rows="5" cols="15"><?php echo html($plugin['data']['shopprod_color']) ?></textarea>
                    </td>
                    <td align="right" class="chatlist width100 tdtop4"><?php echo $BLM['shopprod_special_price'] ?>:&nbsp;</td>
					<td>
                    	<textarea name="shopprod_special_price" id="shopprod_special_price" class="v12 width170" rows="5" cols="15"><?php echo html($plugin['data']['shopprod_special_price']) ?></textarea>
                    </td>
    ...
    <tr>
		<td align="right" class="chatlist tdtop4">
			<?php echo $BLM['prod_seo_tit'] ?>:&nbsp;
        </td>
		<td colspan="2">
        	<input type="text" name="shopprod_seo_tit" id="shopprod_seo_tit" class="v12 width400" value="<?php echo html($plugin['data']['shopprod_seo_tit']) ?>" />
        </td>
	</tr>
    
    <tr>
    	<td colspan="2">
        	<img src="img/leer.gif" alt="" width="1" height="9" />
        </td>
    </tr>
    
    <tr>
		<td align="right" class="chatlist tdtop4">
			<?php echo $BLM['prod_seo_desc'] ?>:&nbsp;
        </td>
		<td colspan="2">
        	<textarea name="shopprod_seo_desc" id="shopprod_seo_desc" class="v12 width400" rows="5"><?php echo html($plugin['data']['shopprod_seo_desc']) ?></textarea>
        </td>
	</tr>
	...
	<tr>
		<td align="right" class="chatlist tdtop4">
			<a href="javascript:void(0)" onclick="return set_shop_prod_alias();">
				<?php echo $BLM['prod_url_produto'] ?>:
            </a>
            &nbsp;
        </td>
		<td colspan="2">
        	<input type="text" name="shopprod_description3" id="shopprod_description3" class="v12 width400" value="<?php echo html($plugin['data']['shopprod_description3']) ?>"  onchange="this.value=create_alias_shop(this.value);" />&nbsp;
            <?php
            if(!empty($plugin['error']['shopprod_description3'])){
				echo '<b style="color:#c00; font-size:11px">'.$plugin['error']['shopprod_description3'].'</b>';
			}
			?>
        </td>
	</tr>
	...
	<tr>
		<td align="left" class="chatlist tdbottom3"><?php echo $BL['be_cnt_description'] ?>:&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
    ...
    <tr>
    	<td colspan="2">
        	<img src="img/leer.gif" alt="" width="1" height="10" />
        </td>
    </tr>
    
	<tr>
		<td align="left" class="chatlist tdbottom3"><?php echo $BLM['shopprod_description0'] ?>:&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td colspan="2" class="tdbottom4"><?php
	...
	*/ ?>
	...
	<tr>
    	<td colspan="2" class="rowspacer7x7">
        	<img src="img/leer.gif" alt="" width="1" height="12" />
        </td>
    </tr>
...
?>
			      ...
			      <td valign="top">
				  <a href="#" title="<?php echo $BL['be_cnt_openimagebrowser'] ?>" onclick="openFileBrowser('filebrowser.php?opt=5&amp;target=nolist');return false;"><img src="img/button/open_image_button.gif" alt="" width="71" height="15" border="0" /></a>
...
?>
		...
		<td valign="top"><img src="img/leer.gif" alt="" width="5" height="1" /></td>
		<td valign="top">
	  	<a href="#" title="<?php echo $BL['be_cnt_openfilebrowser'] ?>" onclick="openFileBrowser('filebrowser.php?opt=9&amp;target=nolist');return false;"><img src="img/button/open_image_button.gif" alt="" width="71" height="15" border="0" /></a>
