...
if($action == 'edit') {
	...
	if(isset($_POST['shopprod_id'])) {
		...
		if( isset($_POST['close']) ) {
			//headerRedirect( shop_url('controller=products', '') );
		}
		...
		$plugin['data']['shopprod_special_price']	= clean_slweg($_POST['shopprod_special_price']);
		...
		$plugin['data']['shopprod_seo_tit']			= clean_slweg($_POST['shopprod_seo_tit']);
		$plugin['data']['shopprod_seo_desc']		= clean_slweg($_POST['shopprod_seo_desc']);
		$plugin['data']['shopprod_description3']	= clean_slweg($_POST['shopprod_description3']);
		$plugin['data']['shopprod_ordenacao']		= clean_slweg($_POST['shopprod_ordenacao']);
		
		// Confere se o alias não está em branco ou se já está sendo utilizado
		if(!$plugin['data']['shopprod_description3']) {
			$plugin['error']['shopprod_description3'] = $BLM['produto_sem_alias'];
		} else {	
			$sql  = 'SELECT COUNT(shopprod_description3) FROM '.DB_PREPEND.'phpwcms_shop_products WHERE ';
			$sql .= "shopprod_status != 9 AND shopprod_description3 LIKE ";
			$sql .= "'". aporeplace($plugin['data']['shopprod_description3']) ."'";
			$sql .= $plugin['data']['shopprod_id'] ? ' AND shopprod_id != ' . $plugin['data']['shopprod_id'] : '';
			if( _dbQuery($sql, 'COUNT') ) {
				$plugin['error']['shopprod_description3'] = $BLM['produto_alias_duplicado'];
			}
		}	
		...
		*/
		...
		if(empty($plugin['error'] )) {
			...
			if( $plugin['data']['shopprod_id'] && $plugin['data']['shopprod_duplicate'] == 0 ) {
				...
				$sql .= "shopprod_seo_tit = '".aporeplace($plugin['data']['shopprod_seo_tit'])."', ";
				$sql .= "shopprod_seo_desc = '".aporeplace($plugin['data']['shopprod_seo_desc'])."', ";
				$sql .= "shopprod_description3 = '".aporeplace($plugin['data']['shopprod_description3'])."', ";
				$sql .= "shopprod_ordenacao = '".aporeplace($plugin['data']['shopprod_ordenacao'])."', ";
				...
				$sql .= "shopprod_special_price = '".aporeplace($plugin['data']['shopprod_special_price'])."', ";
			...
			// INSERT
				...
				$ordem = (!empty($plugin['data']['shopprod_ordenacao'])) ? $plugin['data']['shopprod_ordenacao'] : '100';

				$sql  = 'INSERT INTO '.DB_PREPEND.'phpwcms_shop_products (';
				$sql .= 'shopprod_createdate, shopprod_changedate, shopprod_status, shopprod_ordernumber, ';
				$sql .= 'shopprod_model, shopprod_name1, shopprod_name2, shopprod_tag, shopprod_vat, ';
				$sql .= 'shopprod_netgross, shopprod_price, shopprod_maxrebate, shopprod_description0, ';
				$sql .= 'shopprod_description1, shopprod_description2, shopprod_seo_tit, shopprod_seo_desc, ';
				$sql .= 'shopprod_description3, shopprod_ordenacao, shopprod_var, shopprod_category, ';
				$sql .= 'shopprod_weight, shopprod_size, shopprod_color, shopprod_special_price, shopprod_listall, ';
				$sql .= 'shopprod_lang, shopprod_overwrite_meta, shopprod_opengraph) VALUES (';
				...
				$sql .= "'".aporeplace($plugin['data']['shopprod_seo_tit'])."', ";
				$sql .= "'".aporeplace($plugin['data']['shopprod_seo_desc'])."', ";
				$sql .= "'".aporeplace($plugin['data']['shopprod_description3'])."', ";
				$sql .= $ordem.", ";
				...
				$sql .= "'".aporeplace($plugin['data']['shopprod_special_price'])."', ";
			...
			if( isset($_POST['save']) ) {
				...
				headerRedirect( shop_url( array('controller=products', 'edit='.$plugin['data']['shopprod_id']), '') );
			}
		...
		$plugin['data']['shopprod_seo_tit']			= '';
		$plugin['data']['shopprod_seo_desc']		= '';
		$plugin['data']['shopprod_description3']	= '';
		$plugin['data']['shopprod_ordenacao']		= '';
		...
		$plugin['data']['shopprod_special_price']	= '';
