...
function struct_list ($struct_id, $dbcon, $counter=0) {
	...
	if($result = mysqli_query($dbcon, $sql)) {
		while($row = mysqli_fetch_array($result)) {
			...
			echo "<td><img src=\"img/button/add_13x13.gif\" width=\"13\" height=\"13\">";
			echo "<img src=\"img/button/edit_22x11.gif\" width=\"32\" height=\"13\">";
			echo "<img src=\"img/button/sort_0_1.gif\" width=\"11\" height=\"11\">";
			echo "<img src=\"img/button/sort_1_1.gif\" width=\"13\" height=\"13\">";
			echo "<img src=\"img/button/sort_2_1.gif\" width=\"13\" height=\"13\">";
