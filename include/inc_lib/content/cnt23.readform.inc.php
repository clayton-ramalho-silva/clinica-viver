...
// Google recaptcha
$content['form']['google']           = empty($_POST["cform_google"]) ? 0 : 1;
$content['form']['google_sitekey']   = clean_slweg($_POST["cform_google_sitekey"]);;
$content['form']['google_secretkey'] = clean_slweg($_POST["cform_google_secretkey"]);;
