...
// Adicionar classes
$content['addclassemulti']		= empty($_POST['calink_addclasse_multi']) ? 0 : 1;
$content['numeromulti']		= intval($_POST['calink_numero_multi']);
$content['classemulti']		= $_POST['calink_classe_multi'];

$content['addclasse']			= empty($_POST['calink_addclasse']) ? 0 : 1;
$content['numeroclasse']		= intval($_POST['calink_numero']);
$content['addclasse_classe']			= $_POST['calink_classe'];
...
$content['image_list']['addclassemulti']		= empty($_POST['calink_addclasse_multi']) ? 0 : 1;
$content['image_list']['numeromulti']		= intval($_POST['calink_numero_multi']);
$content['image_list']['classemulti']		= $_POST['calink_classe_multi'];

$content['image_list']['addclasse']			= empty($_POST['calink_addclasse']) ? 0 : 1;
$content['image_list']['numeroclasse']		= intval($_POST['calink_numero']);
$content['image_list']['addclasse_classe']			= $_POST['calink_classe'];
