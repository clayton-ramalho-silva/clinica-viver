...
?>
<form action="phpwcms.php?do=files&amp;f=0" method="post" enctype="multipart/form-data" name="uploadfile" id="uploadfile" class="dados-sumario">
    <h3><?php echo $BL['be_fprivup_title'] ?></h3>
    
	<?php if(isset($file_error["upload"])) { ?>
	
	  <strong style="color:#FF3300"><?php echo $file_error["upload"] ?></strong>
	...
	if(isset($file_error["file"])) { ?>
	  ...
	  <strong style="color:#FF3300"><?php echo $file_error["file"] ?></strong>
	...
	<!-- <?php echo $BL['be_fprivup_upload'] ?> -->
        <p><input name="file" type="file" id="file" size="40" /></p>
...
<!-- <tr bgcolor="#F5F8F9">
	...
	<tr>
		...
		<td><table border="0" cellpadding="0" cellspacing="0" summary="">
		<tr>
			<td>--><input name="file_aktiv" type="hidden" id="file_aktiv" value="1"<?php is_checked("1", $file_aktiv) ?> /><!-- </td>
		...
		<tr>
			<td>--><input name="file_public" type="hidden" id="file_public" value="1"<?php is_checked("1", $file_public) ?> /><!-- </td>
