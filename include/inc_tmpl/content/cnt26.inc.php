...
<tr>
  ...
  <td valign="top"><textarea name="recipe_category" id="recipe_category" cols="40" rows="2" class="f11" style="width:584px"><?php echo html($content['recipe']['category']) ?></textarea></td>
</tr>
...
<tr>
  ...
  <td valign="top"><textarea name="recipe_ingredients" id="recipe_ingredients" cols="40" rows="6" class="f11" style="width:584px"><?php echo html($content['recipe']['ingredients']) ?></textarea></td>
</tr>
