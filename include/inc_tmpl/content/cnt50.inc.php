...
<td valign="top"><textarea name="creference_text" rows="15" wrap="VIRTUAL" class="f11" id="creference_text" style="width: 584px"><?php echo  $content['reference']["text"] ?></textarea></td>
</tr>
...
<tr>
  ...
  <td valign="top"><table border="0" cellpadding="0" cellspacing="0" summary="">
      <tr>
        ...
        <td valign="top"><a href="javascript:;" title="<?php echo $BL['be_cnt_openimagebrowser'] ?>" onclick="openFileBrowser('filebrowser.php?opt=3&amp;target=nolist')"><img src="img/button/open_image_button.gif" alt="" width="71" height="15" border="0"></a><br />
...
<tr>
  ...
  <td valign="top"><textarea name="creference_caption" cols="40" rows="<?php echo (count($content['reference']["list"])) ? (count($content['reference']["list"]) + 4) : 5 ?>" wrap="off" class="f11" id="creference_caption" style="width:584px"><?php echo html($content['reference']["caption"]) ?></textarea></td>
</tr>
<tr><td colspan="2"><img src="img/leer.gif" alt="" width="1" height="5"></td></tr>
<tr>
