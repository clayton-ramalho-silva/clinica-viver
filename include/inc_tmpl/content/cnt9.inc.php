...
<tr>
  <td colspan="2"><table border="0" cellpadding="0" cellspacing="0" summary="">
    <tr>
	  ...
	  <td><img src="img/leer.gif" alt="" width="3" height="1" /><a href="javascript:;" title="<?php echo $BL['be_cnt_openmediabrowser'] ?>" onclick="openFileBrowser('filebrowser.php?opt=2&amp;target=nolist')"><img src="img/button/open_image_button.gif" alt="" width="134" height="15" border="0" /></a></td>
...
<tr>
	  ...
	  <td valign="top"><table border="0" cellpadding="0" cellspacing="0" summary="">
		<tr>
		  ...
		  <td><img src="img/leer.gif" alt="" width="3" height="1" /><a href="javascript:;" title="<?php echo  $BL['be_cnt_openimagebrowser'] ?>" onclick="openFileBrowser('filebrowser.php?opt=0&amp;target=nolist')"><img src="img/button/open_image_button.gif" alt="" width="71" height="15" border="0" /></a></td>
