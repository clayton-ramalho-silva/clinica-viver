...
?><tr>
	...
	<td><input name="cmailsubject" type="text" id="cmailsubject" class="f11b" style="width: 584px" value="<?php echo  isset($content["mailsubject"]) ?  html($content["mailsubject"]) : '' ?>" size="40" maxlength="250"></td>
</tr>
<tr><td colspan="2"><img src="img/leer.gif" alt="" width="1" height="3"></td></tr>
<tr>
	<td align="right" class="chatlist"><?php echo $BL['be_cnt_recipient'] ?>:&nbsp;</td>
	<td><input name="cmailrecipient" type="text" id="cmailrecipient" class="f11b" style="width: 584px" value="<?php echo  isset($content["mailrecipient"]) ? html($content["mailrecipient"]) : '' ?>" size="40" maxlength="250"></td>
</tr>
<tr><td colspan="2"><img src="img/leer.gif" alt="" width="1" height="3"></td></tr>
<tr>
...
<tr>
	...
	<td valign="top"><textarea name="cmailform" rows="15" wrap="off" class="msgtext" id="cmailform" style="width: 584px"><?php
