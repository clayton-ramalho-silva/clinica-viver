...
<tr>
  ...
  <td valign="top"><textarea name="csitemap_before" cols="40" rows="3" class="code" id="csitemap_before" style="width: 584px"><?php echo html($content["sitemap"]["before"]) ?></textarea></td>
</tr>
...
<tr>
  ...
  <td valign="top"><textarea name="csitemap_after" cols="40" rows="3" class="code" id="csitemap_after" style="width: 584px"><?php echo html($content["sitemap"]["after"]) ?></textarea></td>
</tr>
...
<tr>
	...
	<td><select name="csitemap_startid" id="csitemap_startid" style="width: 591px" class="f11b">
<?php
