...
<tr>
  ...
  <td valign="top"><textarea name="cguestbook_banned" cols="40" rows="3" class="f11" style="width:584px"><?php echo  isset($content["guestbook"]["banned"]) ? html($content["guestbook"]["banned"]) : '' ?></textarea></td>
</tr>
