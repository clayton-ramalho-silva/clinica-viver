...
?>
				  ...
				  onclick="openFileBrowser('filebrowser.php?opt=1&amp;target=nolist');"><img src="img/button/open_image_button.gif" alt="" width="71" height="15" border="0"></a><br /><img src="img/leer.gif" alt="" width="1" height="4"><br /><a href="javascript:;"
