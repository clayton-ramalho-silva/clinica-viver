...
$no_durchlauf = 0;
        ...
        <tr><td><table width="<?php echo $phpwcms['LarguraInterna']; ?>" border="0" cellpadding="2" cellspacing="0" summary=""><tr>
	  ...
	  ?>
	  <table width="<?php echo $phpwcms['LarguraInterna']; ?>" border="0" cellpadding="0" cellspacing="0" summary="">
        <tr><td colspan="3"><img src="img/lines/l538_70.gif" alt="" width="<?php echo $phpwcms['LarguraInterna']; ?>" height="1"></td></tr>
		<tr>
		...
		<tr><td colspan="3" class="title"><img src="img/lines/l538_70.gif" alt="" width="<?php echo $phpwcms['LarguraInterna']; ?>" height="1"></td></tr>
        <tr><td colspan="3"><img src="img/leer.gif" alt="" width="1" height="1"></td></tr>
	...
	<tr><td colspan="4"><img src="img/lines/l538_70.gif" alt="" width="<?php echo $phpwcms['LarguraInterna']; ?>" height="1"></td></tr>
