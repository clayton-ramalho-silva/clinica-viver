...
?>
<!--<table width="<?php echo $phpwcms['LarguraInterna']; ?>" border="0" cellpadding="0" cellspacing="0" summary="" class="tabela-pagina">-->
<div class="tabela-pagina">
<h1 class="title"><?php echo $BL['be_article_title'] ?></h1>
...
//$a .= '<td nowrap="nowrap">';
$a .= ($child_count) ? "<div class=\"lista-pagina-menu\" style=\"margin-top:0;\"><span><a href=\"phpwcms.php?do=articles&amp;open=0:".(($_SESSION["structure"][0])?0:1)."\">" : "";
...
$a .= "<i class=\"far fa-".(($child_count) ? (($_SESSION["structure"][0]) ? "minus-square" : "plus-square") : "square") ."\"></i></a>";
...
//$a .= '<td class="dir" width="97%">teste<strong>'.$an."</strong></td>\n</tr>\n</table></td>\n";
$a .= '<strong>'.$an."</strong>\n";

echo $a;
//echo '<td width="105" nowrap="nowrap" class="botoes-controle">';
echo '</span><div class="botoes-controle">';
