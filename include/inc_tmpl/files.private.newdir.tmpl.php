...
?>
<form action="phpwcms.php?do=files&amp;f=0" method="post" name="createnewdir" id="createnewdir" class="dados-sumario">
    <h3><?php echo $BL['be_fpriv_title'] ?> <?php echo $BL['be_fpriv_inside'] ?>: <strong><?php echo $dir_parent_name ?></strong></h3>
...
<!--	<tr>
	...
	<tr><td colspan="2"><img src="img/leer.gif" alt="" width="1" height="5" /></td></tr>x
	...
	<tr>
		...
		<tr>
			<td> --><input name="dir_aktiv" type="hidden" id="dir_aktiv" value="1"<?php is_checked("1", $dir_aktiv) ?> /><!-- </td>
			<td class="v10"><strong><label for="dir_aktiv"><?php echo $BL['be_ftptakeover_active'] ?></label></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>

			<td> --><input name="dir_public" type="hidden" id="dir_public" value="1"<?php is_checked("1", $dir_public) ?> /><!-- </td>
