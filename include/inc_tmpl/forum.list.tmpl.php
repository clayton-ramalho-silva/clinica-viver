...
if($result = mysql_query($sql, $db) or die("error while listing forums")) {
	while($row = mysql_fetch_assoc($result)) {
		...
		echo '<img src="img/button/del_13x13_1.gif" width="13" height="13">';
...
<table width="<?php echo $phpwcms['LarguraInterna']; ?>" border="0" cellpadding="0" cellspacing="0" summary="">
	...
	<tr bgcolor="#E6EAED">
		...
		<td><input name="forum_title" type="text" class="f11b" id="forum_title" style="width:584px" value="<?php echo $forum["title"] ?>" size="50" maxlength="250"></td>
	</tr>
	...
	<tr bgcolor="#E6EAED">
		...
		<td><textarea name="forum_text" cols="35" rows="6" class="f11" id="forum_text" style="width:584px"><?php echo $forum["text"]; ?></textarea></td>
	</tr>
