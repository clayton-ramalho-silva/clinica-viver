...
<table border="0" cellpadding="0" cellspacing="0" summary="newsletter subscription form">
	...
	<tr>
		...
		<td><input name="subscription_name" type="text" class="f11b" id="subscription_name" style="width:584px" value="<?php echo  empty($subscription["name"]) ? '' : html($subscription["name"]) ?>" size="50" maxlength="250" /></td>
	</tr>
	
	<tr><td colspan="2"><img src="img/leer.gif" alt="" width="1" height="5" /></td></tr>
	<tr>
		<td align="right" valign="top" class="chatlist" style="padding-top:3px;"><?php echo $BL['be_newsletter_info'] ?>:&nbsp;</td>
		<td><textarea name="subscription_info" cols="35" rows="6" class="f11" id="subscription_info" style="width:584px"><?php echo  empty($subscription["info"]) ? '' : html($subscription["info"]); ?></textarea></td>
	</tr>
