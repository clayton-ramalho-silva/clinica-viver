...
<h1 class="title"><?php echo $BL['be_admin_struct_title'] ?></h1>
...
echo "<div class=\"lista-pagina-menu\"><span>";
...
echo 'Menu: <b>' . $indexpage['acat_name'] . "</b></span>";
//echo '<td width="99" nowrap="nowrap">';
echo '<div class="botoes-controle">';
...
<script>
    ...
    function addClasse() {
        document.getElementById("be_main_content").classList.add("estrura-paginas");
    }
    window.onload = addClasse;
 </script>