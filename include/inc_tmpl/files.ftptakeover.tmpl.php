...
<div class="paginas-centro-arquivos">
    <span>
        <a class="link-carregar-arquivos button10" href="phpwcms.php?do=files&p=8">Carregar V�rios Arquivos</a>
...
<form action="include/inc_act/act_ftptakeover.php" method="post" name="ftptakeover" id="ftptakeover" class="dados-sumario">
<h3><?php echo $BL['be_files_select_available'] ?></h3>
...
<div class="espacamento"></div>
   ...
   <p class="lista-arquivos-linha-titulo">
            ...
            <span><?php echo $BL['be_ftptakeover_available'] ?></span>
            <span class="fr"><?php echo $BL['be_ftptakeover_size'] ?></span>
        ...
        <!--</tr>-->
<!--          <tr bgcolor="#D9DEE3">
            <td width="35" align="center"><?php echo $BL['be_ftptakeover_mark'] ?></td>
            ...
            <td width="400"><?php echo $BL['be_ftptakeover_available'] ?></td>
            <td width="1" bgcolor="#F2F3F5"><img src="img/leer.gif" alt="" width="1" height="1" /></td>
            <td width="80" align="right"><?php echo $BL['be_ftptakeover_size'] ?>&nbsp;&nbsp;</td>
          </tr>-->
<!--		  <tr bgcolor="#92A1AF"><td colspan="6" bgcolor="#D9DEE3"><img src="img/leer.gif" alt="" width="1" height="1" /></td>
        ...
        <p class="lista-arquivos-linha" <?php echo $fxb ?>>
            <span><input name="ftp_mark[<?php echo $fx ?>]" type="checkbox" id="ftp_mark_<?php echo $fx ?>" value="1" class="ftp_mark" /></span>
            <img src="img/icons/small_<?php echo $fxe ?>" alt="" width="13" height="11" />
            <?php echo $filename ?>
            <strong class="fr"><?php echo fsizelong($fxs) ?></strong>
        ...
        <p><?php echo $BL['be_ftptakeover_nofile'] ?></p>
        ...
        <p class="lista-arquivos-linha-total">
            ...
            <strong class="fr"><?php echo fsizelong($fxsg) ?></strong>
...
<div class="barra"></div>
    ...
    <p>
        ...
        <select name="file_dir" id="file_dir">
...
?>
	...
	<tr><td colspan="2"><img src="img/lines/line-bluelight.gif" alt="" width="<?php echo $phpwcms['LarguraInterna']; ?>" height="1" /></td></tr>
	...
	if($result = mysqli_query($db, $sql) or die("aerror while browsing file categories for selecting keywords1")) {
		$k = "";
...
<!--                  <table border="0" cellpadding="4" cellspacing="0" summary="">
                  <tr>
                    <td>
                     </td><td class="v10"><strong><label for="file_aktiv"><?php echo $BL['be_ftptakeover_active'] ?></label></strong>&nbsp;&nbsp;</td>
                    <td>
                    </td><td class="v10"><strong><label for="file_public"><?php echo $BL['be_ftptakeover_public'] ?></label></strong>&nbsp;&nbsp;</td>
					<td></td>
                    <td class="v10"><strong></strong>&nbsp;</td>
                  </tr>
                </table>-->
<!--              </td>
            </tr>
          ...
          <tr bgcolor="#92A1AF"><td colspan="2"><img src="img/leer.gif" alt="" width="1" height="1" /></td>
            ...
            <p>
                      <input name="file_aktiv" type="hidden" id="file_aktiv" value="1"<?php is_checked($phpwcms['set_file_active'], 1) ?> />
                      <input name="file_public" type="hidden" id="file_public" value="1"<?php is_checked($phpwcms['set_file_active'], 1) ?> />

                      <label class="botoes" for="file_replace">
                          <input name="file_replace" type="checkbox" id="file_replace" value="1" />
                  ...
                  <p>
                      ...
                      <input name="Submit" type="submit" class="button10" value="<?php echo $BL['be_ftptakeover_button'] ?>" />
                  </p>
