...
?>
<form action="phpwcms.php?do=files&amp;f=0" method="post" name="editdir" id="editdir" class="dados-sumario">
    <h3><?php echo $BL['be_fpriv_edittitle'] ?>: <strong><?php echo $dir_oldname ?></strong></h3> 
	...
	<strong style="color:#FF3300;"><?php echo $BL['be_fpriv_error'] ?></strong>
    <?php } ?>
    
    <p>
        <b><?php echo $BL['be_ftptakeover_directory'] ?></b>
        <select name="dir_pid" id="dir_pid" class="width400">
    ...
    <p>
        <b><?php echo $BL['be_fpriv_newname'] ?></b>
        <input name="dir_newname" type="text" class="width440 v12" id="dir_newname" value="<?php echo html($dir_newname) ?>" size="40" maxlength="250" />
    </p>
    <p>
    ...
    <p style="display: none"><input name="dir_aktiv" type="checkbox" id="dir_aktiv" value="1"<?php is_checked("1", $dir_aktiv) ?> />
            <strong><?php echo $BL['be_ftptakeover_active'] ?></strong>
            <input name="dir_public" type="checkbox" id="dir_public" value="1"<?php is_checked("1", $dir_public) ?> />
            <strong><?php echo $BL['be_ftptakeover_public'] ?></strong>
        </p>
    
<!--<table width="<?php echo $phpwcms['LarguraInterna']; ?>" border="0" cellpadding="0" cellspacing="0" bgcolor='#EBF2F4' summary="">
	<tr>
	...
	<tr><td colspan="2" valign="top"><img src="img/lines/line-bluelight.gif" alt="" width="<?php echo $phpwcms['LarguraInterna']; ?>" height="1" /></td>
	</tr>
	<tr><td colspan="2" valign="top"><img src="img/leer.gif" alt="" width="1" height="6" /></td></tr>
	<?php if($dir_error > 1) { ?>
	<tr>
	...
	<tr><td colspan="2" valign="top"><img src="img/leer.gif" alt="" width="1" height="1" /><input name="dir_aktiv" type="hidden" id="dir_aktiv" value="1" checked /><input name="dir_public" type="hidden" id="dir_public" value="1" checked /></td></tr>
	</tr>		
